    ...
    <basic-container>
      <avue-crud
        ...
        <template slot="menu" slot-scope="scope">
          <el-button type="text" v-if="roleManager_btn_edit" icon="el-icon-edit" @click="handleUpdate(scope.row,scope.index)">编辑</el-button>
          <el-button type="text" v-if="roleManager_btn_del" icon="el-icon-delete" @click="handleDelete(scope.row,scope.index)">删除</el-button>
          <el-button type="text" v-if="roleManager_btn_perm" icon="el-icon-plus" @click="handlePermission(scope.row,scope.index)">权限</el-button>
        </template>
      </avue-crud>
    </basic-container>
